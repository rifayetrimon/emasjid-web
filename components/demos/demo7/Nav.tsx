...
export default function Demo7Nav({ menuItems, logo, socialLinks }: Props) {
        ...
        <nav className="hidden lg:flex items-center gap-1">
          {menuItems.map((item, i) => (
            <div key={i} className="relative group">
              <a
                href={item.link || "#"}
                className="px-4 py-2 rounded-full text-sm font-medium text-gray-700 hover:bg-gray-100/80 transition-all flex items-center gap-1"
              >
                {item.label}
